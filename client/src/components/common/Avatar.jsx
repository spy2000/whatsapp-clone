...
function Avatar({type, image,setImage}) {
  ...
  const photoPickerChange = async (e) => {
    ...
    setTimeout(()=>setImage(data.src),1000)
  ...
  return <>
    ...
    {type === "xl" && (
      ...
      >
      <div className={`z-10 bg-photopicker-overlay-background h-60 w-60 absolute flex items-center justify-center rounded-full flex-col text-center gap-2
