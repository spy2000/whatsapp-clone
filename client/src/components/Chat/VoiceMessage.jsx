...
function VoiceMessage({message}) {
  ...
  const [currentPlaybackTime,setCurrentPalybackTime] = useState(0)
  ...
  useEffect(()=>{
    ...
    waveform.current.on("ready",()=>{
      setTotalDuration(waveform.current.getDuaration)
    })
  },[message.message])
  ...
  useEffect(()=>{
    if(audioMessage){
      const updatePlayBackTime = () => {
        setCurrentPalybackTime(audioMessage.currentTime)
      }
